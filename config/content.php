...
return [
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/kochman-artykul',
        'view' => 'kochman-artykul',
      ),
      1 => 
      array (
        'slug' => 'kochman-epbd',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/rosolowski-energetyka',
        'view' => 'rosolowski-energetyka',
      ),
      1 => 
      array (
        'slug' => 'rosolowski-atom',
        'title' => 'Polski atom – piętnaście lat wahań, trzy lata działań',
        'path' => '/rosolowski-atom',
        'view' => 'rosolowski-atom',
      ),
    ),
  ),
  'luczuk' => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/domanska-artykul',
        'view' => 'domanska-artykul',
      ),
    ),
  ),
  'lewandowski' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/lewandowski-sedziowie',
        'view' => 'lewandowski-sedziowie',
      ),
    ),
  ),
  'kochan' => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/gursztyn-artykul',
        'view' => 'gursztyn-artykul',
      ),
    ),
  ),
  'kita' => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/swietlik-artykul',
        'view' => 'swietlik-artykul',
      ),
    ),
  ),
  'rutke' => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/bochenek-artykul',
        'view' => 'bochenek-artykul',
      ),
    ),
  ),
  'trochanowska' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/trochanowska-artykul',
        'view' => 'trochanowska-artykul',
      ),
    ),
  ),
  'bruszewski' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/bruszewski-artykul',
        'view' => 'bruszewski-artykul',
      ),
    ),
  ),
  'okolowski' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/okolowski-artykul',
        'view' => 'okolowski-artykul',
      ),
    ),
  ),
  'lempicka-wyszynska' => 
  array (
    'slug' => 'lempicka-wyszynska',
    ...
    array (
      ...
      array (
        ...
        'path' => '/lempicka-artykul',
        'view' => 'lempicka-artykul',
      ),
    ),
  ),
  'horoszko' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/horoszko-artykul',
        'view' => 'horoszko-artykul',
      ),
    ),
  ),
  'giera' => 
  ...
  array (
    ...
    'bio' => 'polski historyk, analityk Instytutu Zachodniego, autor licznych książek m.in. Polska — „Niespełniony sojusznik Hitlera"; „Piłsudski: między Stalinem a Hitlerem"; „Piekielni sąsiedzi. Jak Rosja i Niemcy dogadywały się kosztem Polski".',
    'photo' => '/images/Rak.png',
    'articles' => 
    array (
      0 => 
      array (
  ...
  array (
    'slug' => 'dakowski',
    'name' => 'Marek Dakowski',
    'bio' => 'absolwent Akademii Sztuk Pięknych w Warszawie i Szkoły Wajdy. Realizator filmowy, dokumentalista, producent wideo. Współpracował m.in. z TVP, TV Republika i Polskim Radiem.',
    'photo' => '/images/Dakowski.png',
    'articles' => 
    array (
      0 => 
      array (
        ...
        'path' => '/dakowski-artykul',
        'view' => 'dakowski-artykul',
      ),
    ),
  ),
  'rowinski' => 
  array (
    ...
    'bio' => 'absolwent studiów w Instytucie Stosowanych Nauk Społecznych Uniwersytetu Warszawskiego. Pisarz, publicysta, autor lub współautor wielu cenionych książek m.in.  *Bękarty Dantego; * *Królestwo nie z tegoświata. O zasadach Polski katolickiej na podstawie wydarzeń nowszych i dawniejszych; * Alarm dla Kościoła. Nowa reformacja?; * Non possumus. Niezgoda, której uczy Kościół; * *Turbopapiestwo. O dynamice pewnego kryzysu czy Anachroniczna nowoczesności. Szkice o cywilizacji przemocy.*',
    'photo' => '/images/Rowinski.png',
    'articles' => 
    array (
      0 => 
      array (
        ...
        'path' => '/rowinski-artykul',
        'view' => 'rowinski-artykul',
      ),
    ),
  ),
  'feszler' => 
  ...
  array (
    ...
    'bio' => 'Historyk, doktor nauk humanistycznych, kierownik Działu Naukowo-Badawczego Muzeum Historii Polskiego Ruchu Ludowego oraz autor książek z zakresu historii XX wieku m.in.* Stanisław Osiecki (1875-1967). Polityk z pasją; Jan Dębski (1889-1976). Polityk kompromisu*',
    'photo' => '/images/Ratynski.png',
    'articles' => 
    array (
      0 => 
      array (
        ...
        'path' => '/ratynski-artykul',
        'view' => 'ratynski-artykul',
      ),
    ),
  ),
  'trabinski' => 
  array (
    ...
    array (
      ...
      array (
        ...
        'path' => '/trabinski-artykul',
        'view' => 'trabinski-artykul',
      ),
    ),
  ),
),
